...
library(survival)    
setwd("D:\\biowolf\\Ferroptosis\\25.TCGAindep")    
...
bioForest(coxFile="uniCox.txt",forestFile="uniForest.pdf",height=3.5)
bioForest(coxFile="multiCox.txt",forestFile="multiForest.pdf",height=3.5)
